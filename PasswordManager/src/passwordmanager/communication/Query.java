...
public class Query<T> extends Message<T> {
	...
	/**
	 * Creates a new instance of a Query object with the specified authorization token and the specified CommunicationOperation
	...
	/**
	 * Creates a new instance of a Query object with the specified authorization token, CommunicationOperation and data
	 * @param authToken The authorization token
	 * @param operation The CommunicationOperation
	 * @param data The data
	 */
