...
public class AddCredentialModel extends AbstractObservable<AddCredentialModel> {
	...
	/**
	 * Creates a new instance of the AddCredentialModel class with the specified PasswordClient object
	...
	/**
	 * Add a Credential object to the database with the specified UserAccount e-mail address, url, username and password
